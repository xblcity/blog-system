...
import { ArticleItem } from '@views/ArticleList/ArticleItem' // 导入Interface
import styles from './index.scss'
import Editor from '@components/EditArticle'
  ...
  return (
    <div className={styles.updateArticle}>
      ...
      <div className={styles.footer}>
        <Button
          onClick={() => triggerShowEditArticle(false)}
